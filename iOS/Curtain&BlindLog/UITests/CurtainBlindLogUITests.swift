...
final class CurtainBlindLogUITests: XCTestCase {
    ...
    func testAddItemFlow() {
        ...
        let field1 = app.textFields["fieldRoom"]
        XCTAssertTrue(field1.waitForExistence(timeout: 2))
        field1.tap()
        field1.typeText("Test Room")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["Test Room"].waitForExistence(timeout: 2))
    }
